                                            ...
                                            <tr>
                                                ...
                                                <td width="15%">
                                                    <div class="form-group">
                                                        <input data-plant-id="<?=$result['plant_id']?>" data-package-id="<?=$pkg_id?>" name="quantity" type="number" min="1" class="form-control quantity" placeholder="Enter Quantity">
                                                    </div>
                                                </td>
                                            </tr>
                                    <?php } } ?>
