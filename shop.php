                            ...
                            <div class="col-12">
                                <div class="product-topbar d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="total-products">
                                       <?php $total_product = $pro->count_total_product_value();?>

                                        <p><span><?=$total_product;?></span> products found</p>
                                    </div>
                                    <!-- Sorting -->
                                </div>
                            </div>
...
<!-- pagination end-->
                        <div class="row">
                        <?php
                            $getallproduct = $pro->getallproductforuser();
                            if ($getallproduct) {
